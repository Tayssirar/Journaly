...
function TeacherJournal({ userRole }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const staticData = [
                { num: 1, classe: 'Classe 1', module: 'Module 1', journee: 'Jour 1', Date: '2023-06-01', comment: 'Initial comment 1' },
                { num: 2, classe: 'Classe 2', module: 'Module 2', journee: 'Jour 2', Date: '2023-06-02', comment: 'Initial comment 2' },
                { num: 3, classe: 'Classe 3', module: 'Module 3', journee: 'Jour 3', Date: '2023-06-03', comment: 'Initial comment 3' },
                // Add more static data as needed
            ];
            setJournals(staticData);
    ...
    const chargeData = (first, sec) => {
        setFilteredData(journals.slice(first, sec));
    };

    const pagination = Array(Math.ceil(journals.length / sort))
        .fill()
        .map((_, i) => i + 1);
    ...
    const handleSaveComment = () => {
        ...
        updatedJournals[globalIndex].comment = currentComment;
        setJournals(updatedJournals);
        setFilteredData(updatedJournals.slice(activePage * sort, (activePage + 1) * sort));
        setShowModal(false);
    };
