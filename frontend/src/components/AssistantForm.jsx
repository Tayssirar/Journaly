...
function AssistantForm({ mode, initialValues, onSubmit }) {
      ...
      <form onSubmit={handleSubmit}>
            <div className="row">
                ...
                <div className="form-label">
                    Responsable de : {checkedSchoolOptions.join(', ')}
                </div>
                </div>
            </div>
                <div className="col-sm-6">
                ...
                <div className="col-lg-12 col-md-12 mt-3 col-sm-12">
                    <button type="submit" className="btn btn-primary me-1" /*onClick={AddAssistantData}*/>Submit</button>
