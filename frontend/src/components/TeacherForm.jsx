...
function TeacherForm({ mode, initialValues, onSubmit }) {
    ...
    const [checkedNiveauOptions, setCheckedNiveauOptions] = useState([]);
    ...
    const handleSubmit = (e) => {
        ...
        onSubmit({
            ...
            nomination,
            password,
            checkedNiveauOptions,
        });
    };

    const handleCheckboxChange = (optionValue) => {
      // Update checkedOptions state based on checkbox changes
      if (checkedNiveauOptions.includes(optionValue)) {
          setCheckedNiveauOptions(checkedNiveauOptions.filter((opt) => opt !== optionValue));
      } else {
          setCheckedNiveauOptions([...checkedNiveauOptions, optionValue]);
      }
    };
    ...
    <div>
      <form onSubmit={handleSubmit}>
            <div className="row">
                ...
                <div className="col-sm-6">
                    <div className="form-group">
                        <label className="form-label" htmlFor="diplome">Diplomé en</label>
                        <input placeholder="Licence .." value={diplome} type="text" className="form-control"
                        onChange={(e) => setDiplome(e.target.value)} required />
                    </div>
                </div>
                <div className="col-sm-6">
                    ...
                    <div className="form-check form-check-inline" key={option.value}>
                        <label className="form-check-label">
                            <input
                                ...
                                value={option.value}
                                checked={checkedNiveauOptions.includes(option.value)}
                ...
                <div className="form-label">
                    Les niveaux à enseignés: {checkedNiveauOptions.join(', ')}
                </div>
                </div>
            </div>
                <div className="col-sm-6">
                ...
                <div className="col-lg-12 col-md-12 mt-3 col-sm-12">
                    <button type="submit" className="btn btn-primary me-1" /*onClick={AddTeacherData}*/>Submit</button>
